...
if(isset($_POST['edit_cat'])){
  ...
  if(empty($errors)){
     ...
     if($result && $db->affected_rows() === 1) {
       $session->msg("s", "La marca fue actualizado con éxito.");
       ...
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           <div class="form-group">
               <input type="text" class="form-group" name="categorie-name" value="<?php echo remove_junk(ucfirst($categorie['name']));?>">
           </div>
