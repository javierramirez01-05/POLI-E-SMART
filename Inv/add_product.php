...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-categorie','product-quantity','buying-price', 'saleing-price','description','prom');
   ...
   if(empty($errors)){
	 ...
	 $p_descrip  = remove_junk($db->escape($_POST['description']));
	 $p_prom  = remove_junk($db->escape($_POST['prom']));
     ...
     $query .=" name,quantity,buy_price,sale_price,categorie_id,media_id,date,description,prom";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}','{$p_descrip}','{$p_prom}'";
     $query .=")";
          ...
          <form method="post" action="add_product.php" class="clearfix">
			  ...
			  <div class="col-md-6">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="prom" placeholder="Promoción">
               </div>
			   </div>
			  </div>
			  </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 50px;"> Imagen</th>
                ...
                <th class="text-center" style="width: 10%;"> Promocion </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['sale_price']); ?></td>
				 <td class="text-center"> <?php echo remove_junk($product['prom']); ?></td>
