  ...
  <?php  if ($session->isUserLoggedIn(true)): ?>
    <header id="header" style="background-color: #9E9E9E;">
	  ...
	  <div class="header-date pull-left">
       <input class="form-control mr-sm-2" type="search" placeholder="¿Que estás buscando hoy?" aria-label="Search" >
	  </div>
	  
	  <div class="logo pull-left">
       <a><img src="libs/images/lupa I.png"/></a>
      </div>
	  <div class="pull-right clearfix">
         <a><img src="libs/images/Carro I.png"/></a>
      </div>
